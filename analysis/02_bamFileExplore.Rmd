...
biscuit epiread -L 100000 data/GRCh38.p13.genome.fa data/cfnano_paper/bam/megalodonModBams/HU005.10.meg242.remora1.edgefix.mod_mappings.sorted.hg38.bam
...
new idea: make fasta out of bam
then it will have all the seq bits
but having trouble installing samtools with conda
bunch of package req and funny business
but homebrew says its already installed
but I can't use it
and now terminal is frozen so I can't do anything anyway
was going to load it on cluster
